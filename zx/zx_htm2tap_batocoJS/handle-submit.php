...
//$file_name
$output = "run_batoco.php?input=".$target_subfolder.$file_name.".htm&n=ZMB-TEST&o=".$target_subfolder.$file_name.".tap";
//$output = "run_batoco.php?input=".$target_subfolder.$file_name.".htm&n=ZMB-TEST&o=".$file_name.".tap";
//$output2 = shell_exec('./zmakebas64_jon '.$target_subfolder.$file_name.".htm"." -o ".$target_subfolder.$file_name.".tap"    ); //zmakebas64 seem to work better
...
<?php 
 echo '
	...
	echo '	
		...
		window.open(  "'.$output.'"   , "emulator_output");
		//history.back() ; //history.go(-1)
