...
<head>
    ...
    Changes:
    v09e_260107 - Fixed zero goals from player teammates.
...
<body>
    ...
    <script>
        ...
        function simulateMatchWithPlayerGoals(team1, team2, divKey, playerGoals) {
            ...
            // Calculate random teammate goals (0-2, varies by division)
            const teammateGoals = Math.floor(Math.random() * (1.3 + divStrength));
            ...
            if (team1 === player.currentClub) {
                goals1 = playerGoals  + teammateGoals;  // Your goals + teammates
                goals2 = opponentGoals;
            } else {
                goals1 = opponentGoals;
                goals2 = playerGoals + teammateGoals;  // Your goals + teammates
            }
