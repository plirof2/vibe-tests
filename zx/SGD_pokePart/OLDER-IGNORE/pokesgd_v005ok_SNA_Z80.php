 ...
 *
 * Examples :
 * pokesgd_v005.php?file=ROMSMINE/F/FIRELORD.SNA&POKES=34509,0:34984,58  (SNA)
 * pokesgd_v005.php?file=ROMSMINE/F/FIRELORD.Z80&POKES=34509,0:34984,58  (v1.45)
 * pokesgd_v005.php?file=ROMSMINE/L/LASTDUEL.Z80&POKES=37605,0:37672,0:40063,0 (v2.01)
 * pokesgd_v005.php?file=ROMSMINE/L/LIGHT128.Z80&POKES=40750,0:40754,0 (v3 128k)
 * pokesgd_v005.php?file=ROMSMINE/L/LASTVAMP.Z80&POKES=51813,0:51814,0 (v3)
 *
 *
 *
 * @version 0.05 - Merged SNA support from pokeSNA_v01.php
...
try {
    ...
    if ($extension === 'sna') {
        ...
        if (!empty($pokesString)) {
            ...
            throw new Exception("SNA files require POKES parameter (POK file parsing not supported for SNA)");
        }
