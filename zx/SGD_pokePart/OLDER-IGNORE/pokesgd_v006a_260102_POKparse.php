<?php
/**
 * ZX Spectrum Z80/SNA POKE Patching Script v0.05
 * 
 ...
 * 
 * Usage: pokesgd_v005.php?file=path/to/file.Z80&POKES=address,value:address,value
 * Alternative: pokesgd_v005.php?file=path/to/file.Z80 (uses file.POK in POKES/ subdirectory)
 * Also supports: pokesgd_v005.php?file=path/to/file.SNA&POKES=address,value:address,value
 * 
 *
 * Examples :
 * pokesgd.php?file=ROMSMINE/F/FIRELORD.SNA&POKES=34509,0:34984,58  (SNA)
 * pokesgd.php?file=ROMSMINE/F/FIRELORD.Z80&POKES=34509,0:34984,58  (v1.45)
 * pokesgd.php?file=ROMSMINE/L/LASTDUEL.Z80&POKES=37605,0:37672,0:40063,0 (v2.01)
 * pokesgd.php?file=ROMSMINE/L/LIGHT128.Z80&POKES=40750,0:40754,0 (v3 128k)
 * pokesgd.php?file=ROMSMINE/L/LASTVAMP.Z80&POKES=51813,0:51814,0 (v3)
 *
 *
 *
 * @version 0.06 - Merged SNA support from pokeSNA_v01.php
 *                - For .SNA files, calls SNA-specific functions
 *                - For .Z80 files, uses existing v004 logic
 *                - .POK file parsing for all if no POKE parameter is specified
 */
...
try {
    ...
    if (empty($file)) {
        throw new Exception("Missing 'file' parameter. Usage: pokesgd_v005.php?file=path/to/file.Z80&POKES=address,value:address,value");
    }
